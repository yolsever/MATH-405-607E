...
% Based on analysis, the largest value to stay in stability region is h^4/8 which is approximately equal to 4.88e-8
...
%% BCs
% To do periodic we would have various corner terms to fill in...
% Or use the trick of building the Laplacian and square it
...
% for analysis, use "eigs" not "eig"
evs = eigs(H, 10, 'lm')   % lm = largest magnitude
largest_k = 2 / max(abs(evs))
